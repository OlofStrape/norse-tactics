...
export const midgardQuests = [
    createQuest('training-grounds', 'The Art of Combat', 'Learn the basics of card combat from Astrid the Shield-Maiden.', 'midgard', createOpponent('shield-trainer', 'Astrid the Shield-Maiden', 'A patient but demanding teacher', 'easy', ['shield-maiden', 'viking-warrior', 'viking-warrior', 'berserker', 'einherjar'], { aggressiveness: 0.5 }), { cardIds: ['shield-maiden'], experience: 1000, unlocks: ['village-defense'] }, { playerLevel: 1 }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: false, elements: false, ragnarok: false }, {}),
...
export const jotunheimQuests = [
    createQuest("jotunheim-arrival", "Arrival in Jotunheim", "Enter the land of the giants.", "jotunheim", createOpponent("frost-giant-scout", "Frost Giant Scout", "A wary scout testing your right to enter Jotunheim", "medium", ["jotun-warrior", "draugr", "niflheim", "berserker", "shield-maiden"], { aggressiveness: 0.7 }), { cardIds: ["jotun-warrior"], experience: 1000, unlocks: ["jotunheim-quest2"] }, { playerLevel: 33, completedQuests: ["alfheim-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("jotunheim-quest2", "Ice Bridge Crossing", "Cross the treacherous ice bridge guarded by giants.", "jotunheim", createOpponent("bridge-guardian", "Hrímgrímnir", "A giant who controls the icy bridge", "hard", ["jotun-warrior", "niflheim", "draugr", "muspelheim", "shield-maiden"], { aggressiveness: 0.8 }), { cardIds: ["ice-bridge"], experience: 1000, unlocks: ["jotunheim-quest3"] }, { playerLevel: 34, completedQuests: ["jotunheim-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    ...
    createQuest("jotunheim-quest4", "Frost Giant Duel", "Duel a mighty frost giant champion.", "jotunheim", createOpponent("frost-giant-champion", "Frost Giant Champion", "A mighty champion of the frost giants", "medium", ["jotun-warrior", "niflheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.8 }), { cardIds: ["frost-giant"], experience: 1000, unlocks: ["jotunheim-quest5"] }, { playerLevel: 36, completedQuests: ["jotunheim-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("jotunheim-quest5", "Frozen Caverns", "Explore the frozen caverns beneath Jotunheim.", "jotunheim", createOpponent("cavern-guardian", "Cavern Guardian", "Protector of the frozen depths", "medium", ["jotun-warrior", "niflheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.7 }), { cardIds: ["draugr"], experience: 1000, unlocks: ["jotunheim-quest6"] }, { playerLevel: 37, completedQuests: ["jotunheim-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("jotunheim-quest6", "Giant's Feast", "Join the giants in a feast and prove your worth.", "jotunheim", createOpponent("giant-feaster", "Feasting Giant", "A jovial but strong giant", "easy", ["jotun-warrior", "draugr", "niflheim", "berserker", "shield-maiden"], { aggressiveness: 0.5 }), { cardIds: ["jotun-warrior"], experience: 1000, unlocks: ["jotunheim-quest7"] }, { playerLevel: 38, completedQuests: ["jotunheim-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
...
export const nidavellirQuests = [
    createQuest("nidavellir-arrival", "Arrival in Nidavellir", "Enter the forges of the dwarves.", "nidavellir", createOpponent("dvalin-apprentice", "Dvalin the Apprentice", "A young but skilled dwarven smith", "medium", ["dwarf-smith", "shield-maiden", "viking-warrior", "yggdrasil", "draugr"], { aggressiveness: 0.6 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-quest2"] }, { playerLevel: 41, completedQuests: ["jotunheim-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }, {}),
    createQuest("nidavellir-quest2", "Trial by Fire", "Survive the heat of the forges and impress the dwarven masters.", "nidavellir", createOpponent("brokkr", "Brokkr the Forge-Master", "A master smith with a fiery temper", "hard", ["brokkr", "dwarf-smith", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.8 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest3"] }, { playerLevel: 42, completedQuests: ["nidavellir-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("nidavellir-quest3", "Dark Elf Invasion", "Defend the forges from a sudden attack by the dark elves.", "nidavellir", createOpponent("dark-elf-lord", "Svartálfar Lord", "A cunning leader of the dark elves", "hard", ["dark-elf", "dwarf-smith", "muspelheim", "niflheim", "draugr"], { aggressiveness: 0.9 }), { cardIds: ["dark-elf"], experience: 1000, unlocks: ["nidavellir-quest4"] }, { playerLevel: 43, completedQuests: ["nidavellir-quest2"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("nidavellir-quest4", "Dwarven Duel", "Duel a master craftsman of Nidavellir.", "nidavellir", createOpponent("dwarf-champion", "Dwarven Champion", "A master of the forge and the blade", "medium", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.7 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-quest5"] }, { playerLevel: 44, completedQuests: ["nidavellir-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }, {}),
    createQuest("nidavellir-quest5", "Forge Guardians", "Help defend the legendary forges from invaders.", "nidavellir", createOpponent("forge-guardian", "Forge Guardian", "Protector of Nidavellir's forges", "medium", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.7 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest6"] }, { playerLevel: 45, completedQuests: ["nidavellir-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }, {}),
    createQuest("nidavellir-quest6", "Smith's Test", "Pass the test of the dwarven elders.", "nidavellir", createOpponent("dwarf-elder", "Dwarf Elder", "An ancient dwarf of great wisdom", "hard", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.9 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest7"] }, { playerLevel: 46, completedQuests: ["nidavellir-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }, {}),
    createQuest("nidavellir-quest7", "Festival of Forges", "Celebrate with the dwarves in a grand festival.", "nidavellir", createOpponent("festival-host", "Festival Host", "Host of the Nidavellir festival", "easy", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.4 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-boss"] }, { playerLevel: 47, completedQuests: ["nidavellir-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }, {}),
...
export const muspelheimQuests = [
    createQuest("muspelheim-arrival", "Arrival in Muspelheim", "Enter the realm of fire and chaos.", "muspelheim", createOpponent("fire-giant-scout", "Fire Giant Scout", "A scout of Surtr's fiery legions", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.7 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-quest2"] }, { playerLevel: 49, completedQuests: ["nidavellir-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest2", "Surtr's Challenge", "Face Surtr's champion in a battle of fire and fury.", "muspelheim", createOpponent("surtr-champion", "Surtr's Champion", "A mighty warrior wielding the power of Muspelheim", "hard", ["surtr", "fire-giant", "muspelheim", "draugr", "berserker"], { aggressiveness: 0.9 }), { cardIds: ["surtr"], experience: 1000, unlocks: ["muspelheim-quest3"] }, { playerLevel: 50, completedQuests: ["muspelheim-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest3", "Lava Fields", "Navigate the dangerous lava fields of Muspelheim.", "muspelheim", createOpponent("lava-guardian", "Lava Guardian", "Protector of the molten lands", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.8 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest4"] }, { playerLevel: 51, completedQuests: ["muspelheim-quest2"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest4", "Fire Giant Duel", "Duel a mighty fire giant champion.", "muspelheim", createOpponent("fire-giant-champion", "Fire Giant Champion", "A mighty champion of the fire giants", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.8 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-quest5"] }, { playerLevel: 52, completedQuests: ["muspelheim-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest5", "Inferno Guardians", "Help defend the inferno from invaders.", "muspelheim", createOpponent("inferno-guardian", "Inferno Guardian", "Protector of Muspelheim's inferno", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.7 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest6"] }, { playerLevel: 53, completedQuests: ["muspelheim-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest6", "Smith's Fire", "Pass the test of the fire smiths.", "muspelheim", createOpponent("fire-smith", "Fire Smith", "A master of the forge and flame", "hard", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.9 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest7"] }, { playerLevel: 54, completedQuests: ["muspelheim-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("muspelheim-quest7", "Festival of Fire", "Celebrate with the fire giants in a grand festival.", "muspelheim", createOpponent("festival-host", "Festival Host", "Host of the Muspelheim festival", "easy", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.4 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-boss"] }, { playerLevel: 55, completedQuests: ["muspelheim-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
...
export const niflheimQuests = [
    createQuest("niflheim-arrival", "Realm of Ice", "Enter Niflheim, the land of primordial ice and mist.", "niflheim", createOpponent("ice-wraith", "Ice Wraith", "A spirit of the frozen wastes", "medium", ["ice-wraith", "niflheim", "draugr", "shield-maiden", "viking-warrior"], { aggressiveness: 0.7, preferredElements: ['ice'], ragnarokStrategy: 'defensive' }), { cardIds: ['ice-wraith'], experience: 700, unlocks: ['frost-giant-challenge'] }, { playerLevel: 26, completedQuests: ['muspelheim-boss'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }, {}),
    createQuest("frost-giant-challenge", "Frost Giant's Challenge", "Face a mighty frost giant in the heart of Niflheim.", "niflheim", createOpponent("frost-giant", "Frost Giant", "A giant born of ice and ancient magic", "hard", ["frost-giant", "niflheim", "draugr", "ice-wraith", "berserker"], { aggressiveness: 0.9, preferredElements: ['ice'], ragnarokStrategy: 'aggressive' }), { cardIds: ['frost-giant'], experience: 800, unlocks: ['niflheim-boss'] }, { playerLevel: 27, completedQuests: ['niflheim-arrival'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: true, same: true, plus: true, elements: true, ragnarok: true }, {}),
