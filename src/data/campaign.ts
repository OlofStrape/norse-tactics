...
export const asgardQuests = [
    ...
    createQuest("asgard-feast", "Feast of the Einherjar", "Join the warriors in a legendary feast.", "asgard", createOpponent("asgard-feast", "Bragi", "God of poetry and music", "easy", ["bragi", "einherjar"], { aggressiveness: 0.3 }), { cardIds: ["bragi"], experience: 1000, unlocks: ["asgard-quest4"] }, { playerLevel: 11, completedQuests: ["asgard-trial"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest("asgard-quest4", "The Valkyrie's Challenge", "Face a Valkyrie in a test of skill.", "asgard", createOpponent("asgard-valkyrie", "Brynhildr", "A fierce Valkyrie", "medium", ["brynhildr", "einherjar"], { aggressiveness: 0.6 }), { cardIds: ["brynhildr"], experience: 1000, unlocks: ["asgard-quest5"] }, { playerLevel: 12, completedQuests: ["asgard-feast"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest("asgard-quest5", "The Allfather's Wisdom", "Seek Odin's guidance.", "asgard", createOpponent("asgard-odin", "Odin", "The Allfather", "hard", ["odin", "valhalla"], { aggressiveness: 0.8 }), { cardIds: ["odin"], experience: 1000, unlocks: ["asgard-quest6"] }, { playerLevel: 13, completedQuests: ["asgard-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest("asgard-quest6", "The Trickster's Game", "Outwit Loki in a battle of wits.", "asgard", createOpponent("asgard-loki", "Loki", "The Trickster", "medium", ["loki", "einherjar"], { aggressiveness: 0.7 }), { cardIds: ["loki"], experience: 1000, unlocks: ["asgard-quest7"] }, { playerLevel: 14, completedQuests: ["asgard-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest("asgard-quest7", "The Bifrost Bridge", "Defend the Bifrost from invaders.", "asgard", createOpponent("asgard-bifrost", "Heimdall", "Guardian of the Bifrost", "hard", ["heimdall", "valhalla"], { aggressiveness: 0.8 }), { cardIds: ["bifrost"], experience: 1000, unlocks: ["asgard-boss"] }, { playerLevel: 15, completedQuests: ["asgard-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
...
export const vanaheimQuests = [
    createQuest('vanaheim-arrival', 'Arrival in Vanaheim', 'Step into the mystical lands of the Vanir.', 'vanaheim', createOpponent('vanaheim-apprentice', 'Vanir Apprentice', 'A young Vanir learning the ways of magic', 'medium', ['freyr', 'vanaheim'], { aggressiveness: 0.4 }), { cardIds: ['freyr'], experience: 1000, unlocks: ['vanaheim-quest2'] }, { playerLevel: 17, completedQuests: ['asgard-boss'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest2', 'Seidr Secrets', 'Learn the secrets of seidr magic.', 'vanaheim', createOpponent('vanaheim-mystic', 'Vanir Mystic', 'A master of seidr', 'medium', ['freya', 'vanaheim'], { aggressiveness: 0.5 }), { cardIds: ['freya'], experience: 1000, unlocks: ['vanaheim-quest3'] }, { playerLevel: 18, completedQuests: ['vanaheim-arrival'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest3', 'The Vanir Council', 'Impress the Vanir council with your skills.', 'vanaheim', createOpponent('vanaheim-council', 'Vanir Council', 'The ruling council of Vanaheim', 'hard', ['freyr', 'freya'], { aggressiveness: 0.6 }), { cardIds: ['audhumbla'], experience: 1000, unlocks: ['vanaheim-quest4'] }, { playerLevel: 19, completedQuests: ['vanaheim-quest2'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest4', 'Blessing of the Vanir', 'Receive a blessing from the Vanir gods.', 'vanaheim', createOpponent('vanaheim-blesser', 'Vanir Blesser', 'A priest of the Vanir', 'easy', ['freyr', 'freya'], { aggressiveness: 0.3 }), { cardIds: ['folkvangr'], experience: 1000, unlocks: ['vanaheim-quest5'] }, { playerLevel: 20, completedQuests: ['vanaheim-quest3'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest5', 'The Sacred Grove', 'Defend the sacred grove from intruders.', 'vanaheim', createOpponent('vanaheim-grove', 'Grove Guardian', 'Protector of the sacred grove', 'medium', ['freyr', 'freya'], { aggressiveness: 0.5 }), { cardIds: ['yggdrasil'], experience: 1000, unlocks: ['vanaheim-quest6'] }, { playerLevel: 21, completedQuests: ['vanaheim-quest4'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest6', 'The Vanir Duel', 'Duel a Vanir champion.', 'vanaheim', createOpponent('vanaheim-champion', 'Vanir Champion', 'A mighty Vanir duelist', 'hard', ['freyr', 'freya'], { aggressiveness: 0.7 }), { cardIds: ['brisingamen'], experience: 1000, unlocks: ['vanaheim-quest7'] }, { playerLevel: 22, completedQuests: ['vanaheim-quest5'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
    createQuest('vanaheim-quest7', 'The Vanir Festival', 'Celebrate with the Vanir in a grand festival.', 'vanaheim', createOpponent('vanaheim-festival', 'Festival Host', 'Host of the Vanir festival', 'easy', ['freyr', 'freya'], { aggressiveness: 0.2 }), { cardIds: ['folkvangr'], experience: 1000, unlocks: ['vanaheim-boss'] }, { playerLevel: 23, completedQuests: ['vanaheim-quest6'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: true }),
...
export const jotunheimQuests = [
    createQuest("jotunheim-arrival", "Arrival in Jotunheim", "Enter the land of the giants.", "jotunheim", createOpponent("frost-giant-scout", "Frost Giant Scout", "A wary scout testing your right to enter Jotunheim", "medium", ["jotun-warrior", "draugr", "niflheim", "berserker", "shield-maiden"], { aggressiveness: 0.5 }), { cardIds: ["jotun-warrior"], experience: 1000, unlocks: ["jotunheim-quest2"] }, { playerLevel: 33, completedQuests: ["alfheim-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest2", "Ice Bridge Crossing", "Cross the treacherous ice bridge guarded by giants.", "jotunheim", createOpponent("bridge-guardian", "Hrímgrímnir", "A giant who controls the icy bridge", "hard", ["jotun-warrior", "niflheim", "draugr", "muspelheim", "shield-maiden"], { aggressiveness: 0.6 }), { cardIds: ["ice-bridge"], experience: 1000, unlocks: ["jotunheim-quest3"] }, { playerLevel: 34, completedQuests: ["jotunheim-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest3", "Utgard's Challenge", "Face the challenges of Utgard, the stronghold of the giants.", "jotunheim", createOpponent("utgard-loki", "Utgard-Loki", "The trickster king of the giants", "hard", ["utgard-loki", "jotun-warrior", "draugr", "niflheim", "muspelheim"], { aggressiveness: 0.7 }), { cardIds: ["utgard-loki"], experience: 1000, unlocks: ["jotunheim-quest4"] }, { playerLevel: 35, completedQuests: ["jotunheim-quest2"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest4", "Frost Giant Duel", "Duel a mighty frost giant champion.", "jotunheim", createOpponent("frost-giant-champion", "Frost Giant Champion", "A mighty champion of the frost giants", "medium", ["jotun-warrior", "niflheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.6 }), { cardIds: ["frost-giant"], experience: 1000, unlocks: ["jotunheim-quest5"] }, { playerLevel: 36, completedQuests: ["jotunheim-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest5", "Frozen Caverns", "Explore the frozen caverns beneath Jotunheim.", "jotunheim", createOpponent("cavern-guardian", "Cavern Guardian", "Protector of the frozen depths", "medium", ["jotun-warrior", "niflheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.5 }), { cardIds: ["draugr"], experience: 1000, unlocks: ["jotunheim-quest6"] }, { playerLevel: 37, completedQuests: ["jotunheim-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest6", "Giant's Feast", "Join the giants in a feast and prove your worth.", "jotunheim", createOpponent("giant-feaster", "Feasting Giant", "A jovial but strong giant", "easy", ["jotun-warrior", "draugr", "niflheim", "berserker", "shield-maiden"], { aggressiveness: 0.3 }), { cardIds: ["jotun-warrior"], experience: 1000, unlocks: ["jotunheim-quest7"] }, { playerLevel: 38, completedQuests: ["jotunheim-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("jotunheim-quest7", "Thrym's Test", "Face King Thrym in a test of strength.", "jotunheim", createOpponent("king-thrym", "King Thrym", "The colossal king of the frost giants", "hard", ["king-thrym", "utgard-loki", "jotun-warrior", "niflheim", "draugr"], { aggressiveness: 0.9 }), { cardIds: ["thryms-hammer"], experience: 1000, unlocks: ["jotunheim-boss"] }, { playerLevel: 39, completedQuests: ["jotunheim-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
...
export const nidavellirQuests = [
    createQuest("nidavellir-arrival", "Arrival in Nidavellir", "Enter the forges of the dwarves.", "nidavellir", createOpponent("dvalin-apprentice", "Dvalin the Apprentice", "A young but skilled dwarven smith", "medium", ["dwarf-smith", "shield-maiden", "viking-warrior", "yggdrasil", "draugr"], { aggressiveness: 0.4 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-quest2"] }, { playerLevel: 41, completedQuests: ["jotunheim-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }),
    createQuest("nidavellir-quest2", "Trial by Fire", "Survive the heat of the forges and impress the dwarven masters.", "nidavellir", createOpponent("brokkr", "Brokkr the Forge-Master", "A master smith with a fiery temper", "hard", ["brokkr", "dwarf-smith", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.6 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest3"] }, { playerLevel: 42, completedQuests: ["nidavellir-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("nidavellir-quest3", "Dark Elf Invasion", "Defend the forges from a sudden attack by the dark elves.", "nidavellir", createOpponent("dark-elf-lord", "Svartálfar Lord", "A cunning leader of the dark elves", "hard", ["dark-elf", "dwarf-smith", "muspelheim", "niflheim", "draugr"], { aggressiveness: 0.7 }), { cardIds: ["dark-elf"], experience: 1000, unlocks: ["nidavellir-quest4"] }, { playerLevel: 43, completedQuests: ["nidavellir-quest2"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("nidavellir-quest4", "Dwarven Duel", "Duel a master craftsman of Nidavellir.", "nidavellir", createOpponent("dwarf-champion", "Dwarven Champion", "A master of the forge and the blade", "medium", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.5 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-quest5"] }, { playerLevel: 44, completedQuests: ["nidavellir-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }),
    createQuest("nidavellir-quest5", "Forge Guardians", "Help defend the legendary forges from invaders.", "nidavellir", createOpponent("forge-guardian", "Forge Guardian", "Protector of Nidavellir's forges", "medium", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.5 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest6"] }, { playerLevel: 45, completedQuests: ["nidavellir-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }),
    createQuest("nidavellir-quest6", "Smith's Test", "Pass the test of the dwarven elders.", "nidavellir", createOpponent("dwarf-elder", "Dwarf Elder", "An ancient dwarf of great wisdom", "hard", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.7 }), { cardIds: ["brokkr"], experience: 1000, unlocks: ["nidavellir-quest7"] }, { playerLevel: 46, completedQuests: ["nidavellir-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }),
    createQuest("nidavellir-quest7", "Festival of Forges", "Celebrate with the dwarves in a grand festival.", "nidavellir", createOpponent("festival-host", "Festival Host", "Host of the Nidavellir festival", "easy", ["dwarf-smith", "brokkr", "muspelheim", "shield-maiden", "draugr"], { aggressiveness: 0.2 }), { cardIds: ["dwarf-smith"], experience: 1000, unlocks: ["nidavellir-boss"] }, { playerLevel: 47, completedQuests: ["nidavellir-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: false, ragnarok: false }),
...
export const muspelheimQuests = [
    createQuest("muspelheim-arrival", "Arrival in Muspelheim", "Enter the realm of fire and chaos.", "muspelheim", createOpponent("fire-giant-scout", "Fire Giant Scout", "A scout of Surtr's fiery legions", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.5 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-quest2"] }, { playerLevel: 49, completedQuests: ["nidavellir-boss"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest2", "Surtr's Challenge", "Face Surtr's champion in a battle of fire and fury.", "muspelheim", createOpponent("surtr-champion", "Surtr's Champion", "A mighty warrior wielding the power of Muspelheim", "hard", ["surtr", "fire-giant", "muspelheim", "draugr", "berserker"], { aggressiveness: 0.7 }), { cardIds: ["surtr"], experience: 1000, unlocks: ["muspelheim-quest3"] }, { playerLevel: 50, completedQuests: ["muspelheim-arrival"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest3", "Lava Fields", "Navigate the dangerous lava fields of Muspelheim.", "muspelheim", createOpponent("lava-guardian", "Lava Guardian", "Protector of the molten lands", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.6 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest4"] }, { playerLevel: 51, completedQuests: ["muspelheim-quest2"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest4", "Fire Giant Duel", "Duel a mighty fire giant champion.", "muspelheim", createOpponent("fire-giant-champion", "Fire Giant Champion", "A mighty champion of the fire giants", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.6 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-quest5"] }, { playerLevel: 52, completedQuests: ["muspelheim-quest3"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest5", "Inferno Guardians", "Help defend the inferno from invaders.", "muspelheim", createOpponent("inferno-guardian", "Inferno Guardian", "Protector of Muspelheim's inferno", "medium", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.5 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest6"] }, { playerLevel: 53, completedQuests: ["muspelheim-quest4"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest6", "Smith's Fire", "Pass the test of the fire smiths.", "muspelheim", createOpponent("fire-smith", "Fire Smith", "A master of the forge and flame", "hard", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.7 }), { cardIds: ["muspelheim"], experience: 1000, unlocks: ["muspelheim-quest7"] }, { playerLevel: 54, completedQuests: ["muspelheim-quest5"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-quest7", "Festival of Fire", "Celebrate with the fire giants in a grand festival.", "muspelheim", createOpponent("festival-host", "Festival Host", "Host of the Muspelheim festival", "easy", ["fire-giant", "muspelheim", "draugr", "berserker", "shield-maiden"], { aggressiveness: 0.2 }), { cardIds: ["fire-giant"], experience: 1000, unlocks: ["muspelheim-boss"] }, { playerLevel: 55, completedQuests: ["muspelheim-quest6"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("muspelheim-boss", "Surtr, Lord of Fire", "Face Surtr himself in a battle that will decide the fate of the realms.", "muspelheim", createOpponent("surtr", "Surtr", "The lord of Muspelheim, bringer of Ragnarök", "boss", ["surtr", "fire-giant", "muspelheim", "draugr", "berserker"], { aggressiveness: 1.0 }), { cardIds: ["surtr"], experience: 1000, unlocks: ["niflheim-arrival"] }, { playerLevel: 56, completedQuests: ["muspelheim-quest7"] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: true, same: true, plus: true, elements: true, ragnarok: true })
];

export const niflheimQuests = [
    createQuest("niflheim-arrival", "Realm of Ice", "Enter Niflheim, the land of primordial ice and mist.", "niflheim", createOpponent("ice-wraith", "Ice Wraith", "A spirit of the frozen wastes", "medium", ["ice-wraith", "niflheim", "draugr", "shield-maiden", "viking-warrior"], { aggressiveness: 0.5, preferredElements: ['ice'], ragnarokStrategy: 'defensive' }), { cardIds: ['ice-wraith'], experience: 700, unlocks: ['frost-giant-challenge'] }, { playerLevel: 26, completedQuests: ['muspelheim-boss'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: false, same: true, plus: true, elements: true, ragnarok: false }),
    createQuest("frost-giant-challenge", "Frost Giant's Challenge", "Face a mighty frost giant in the heart of Niflheim.", "niflheim", createOpponent("frost-giant", "Frost Giant", "A giant born of ice and ancient magic", "hard", ["frost-giant", "niflheim", "draugr", "ice-wraith", "berserker"], { aggressiveness: 0.7, preferredElements: ['ice'], ragnarokStrategy: 'aggressive' }), { cardIds: ['frost-giant'], experience: 800, unlocks: ['niflheim-boss'] }, { playerLevel: 27, completedQuests: ['niflheim-arrival'] }, { captureRules: { sameElement: false, higherValue: false, adjacent: false }, chainReaction: true, same: true, plus: true, elements: true, ragnarok: true }),
